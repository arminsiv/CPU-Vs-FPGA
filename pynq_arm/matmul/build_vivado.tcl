...
set project_name matmul_overlay
set bd_name matmul_system
set part_name xc7z020clg400-1

file mkdir $vivado_dir
file mkdir $out_dir

set ip_dir [file normalize [file join $build_dir matmul_hls solution1 impl ip]]
...
connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins matmul_0/ap_clk]
...
connect_bd_net [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins matmul_0/ap_rst_n]

connect_bd_intf_net [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ctrl_interconnect/S00_AXI]
connect_bd_intf_net [get_bd_intf_pins ctrl_interconnect/M00_AXI] [get_bd_intf_pins matmul_0/s_axi_CTRL]
connect_bd_intf_net [get_bd_intf_pins matmul_0/m_axi_gmem0] [get_bd_intf_pins mem_interconnect/S00_AXI]
connect_bd_intf_net [get_bd_intf_pins matmul_0/m_axi_gmem1] [get_bd_intf_pins mem_interconnect/S01_AXI]
connect_bd_intf_net [get_bd_intf_pins matmul_0/m_axi_gmem2] [get_bd_intf_pins mem_interconnect/S02_AXI]
